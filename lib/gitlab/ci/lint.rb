  ...
  module Ci
    class Lint
      ...
      def simulate_pipeline_creation(content, ref)
        pipeline = ::Ci::PipelineBuilder
          .new(project, current_user, ref: ref)
          .build!(:push, dry_run: true, content: content)
      ...
      def lint_pipeline_creation(content, ref)
        service = ::Ci::PipelineBuilder.new(project, current_user, ref: ref)
        pipeline = service.build!(:push, linting: true, content: content)
